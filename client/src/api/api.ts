...
export const SystemsApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        systemsSummaryGet: async (options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
...
export const SystemsApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async systemsSummaryGet(options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<SchemasSummary>>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.systemsSummaryGet(options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
    }
};
...
export const SystemsApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        systemsSummaryGet(options?: any): AxiosPromise<Array<SchemasSummary>> {
            return localVarFp.systemsSummaryGet(options).then((request) => request(axios, basePath));
        },
    };
};
...
export class SystemsApi extends BaseAPI {
     ...
     * @memberof SystemsApi
     */
    public systemsSummaryGet(options?: AxiosRequestConfig) {
        return SystemsApiFp(this.configuration).systemsSummaryGet(options).then((request) => request(this.axios, this.basePath));
    }
}
