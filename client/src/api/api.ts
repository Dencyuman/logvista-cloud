...
export const LogsApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async logsPythonLogvistaPost(logs?: Array<SchemasLog>, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<SchemasLogResponse>>> {
...
export const LogsApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        logsPythonLogvistaPost(logs?: Array<SchemasLog>, options?: any): AxiosPromise<Array<SchemasLogResponse>> {
...
export const SystemsApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * DB上に存在するシステムを更新する
         * @summary システム更新
         * @param {string} iD システムID
         * @param {SchemasSystemRequest} system Update System Request
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        systemsPut: async (iD: string, system: SchemasSystemRequest, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'iD' is not null or undefined
            assertParamExists('systemsPut', 'iD', iD)
            // verify required parameter 'system' is not null or undefined
            assertParamExists('systemsPut', 'system', system)
            const localVarPath = `/systems/`;
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
         ...
         * @summary システム集計情報取得
         * @param {string} [id] システムID：指定しない場合は全てのシステムを取得
         * @param {number} [timeSpan] 集計時間スパン（秒）: 10秒刻みで指定可能
         * @param {number} [dataCount] 取得データ個数
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        systemsSummaryGet: async (id?: string, timeSpan?: number, dataCount?: number, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
...
export const SystemsApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async systemsPut(iD: string, system: SchemasSystemRequest, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<string>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.systemsPut(iD, system, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * DB上に存在するシステム別集計情報を取得する
         ...
         * @throws {RequiredError}
         */
        async systemsSummaryGet(id?: string, timeSpan?: number, dataCount?: number, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<SchemasSummary>>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.systemsSummaryGet(id, timeSpan, dataCount, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
    }
};
...
export const SystemsApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        systemsPut(iD: string, system: SchemasSystemRequest, options?: any): AxiosPromise<string> {
            return localVarFp.systemsPut(iD, system, options).then((request) => request(axios, basePath));
        },
        /**
         * DB上に存在するシステム別集計情報を取得する
         * @summary システム集計情報取得
         ...
         * @throws {RequiredError}
         */
        systemsSummaryGet(id?: string, timeSpan?: number, dataCount?: number, options?: any): AxiosPromise<Array<SchemasSummary>> {
            return localVarFp.systemsSummaryGet(id, timeSpan, dataCount, options).then((request) => request(axios, basePath));
        },
    };
};
...
export class SystemsApi extends BaseAPI {
     ...
     * @memberof SystemsApi
     */
    public systemsPut(iD: string, system: SchemasSystemRequest, options?: AxiosRequestConfig) {
        return SystemsApiFp(this.configuration).systemsPut(iD, system, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof SystemsApi
     */
    public systemsSummaryGet(id?: string, timeSpan?: number, dataCount?: number, options?: AxiosRequestConfig) {
        return SystemsApiFp(this.configuration).systemsSummaryGet(id, timeSpan, dataCount, options).then((request) => request(this.axios, this.basePath));
    }
}
